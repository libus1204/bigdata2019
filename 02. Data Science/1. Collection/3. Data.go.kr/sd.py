...
access_key = "QEbF%2Bnfi5HCWciz2PTe%2FWlO%2F1by9CxB8jfRWiyq0IZm%2BrsVxcwMDX%2FkB%2Fb7alBc21fi9EwXCounWbKTu98MDdw%3D%3D"  ## 기상정보 / 대기환경정보 service_key
...
def Update_Scheduler():     ## 인공지능 모드 ON일 경우, 매 시 45분 10초 마다 실시간 정보를 업데이트 하도록 하는 함수
    while True:
        if g_AI_Mode == False:
            ...
            if time.strftime("%M%S") == "5410":     ## 매 시 45분 10초에
