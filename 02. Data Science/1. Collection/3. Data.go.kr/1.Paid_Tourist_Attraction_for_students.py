...
import math
#  서비스 명 : 관광자원통계서비스
access_keys="QEbF%2Bnfi5HCWciz2PTe%2FWlO%2F1by9CxB8jfRWiyq0IZm%2BrsVxcwMDX%2FkB%2Fb7alBc21fi9EwXCounWbKTu98MDdw%3D%3D"
...
def getTourPointVisitor(yyyymm, sido, gungu, nPagenum, nItems):
    ...
    parameters = "?_type=json&serviceKey="+access_keys
...
def getTourPointData(item, yyyymm, jsonResult):
    ...
    rnum = 0 if 'rnun' not in item.keys() else item['rnum']
