...
cust_serv_mean = float(logit_model.params[0]) + float(logit_model.params[1]) * float(churn['account_length'].
                mean()) + float(logit_model.params[2]) * float(churn['custserv_calls'].mean()) + \
...
print("Probability of churn when account length changes by 1 : %.2f" % (inverse_logit(cust_serv_mean) -
